...
public class ScoreAdapter_h extends RealmBaseAdapter<Score> implements ListAdapter {
    ...
    public ScoreAdapter_h(Context context, OrderedRealmCollection<Score> data) {
        super(context, data);
    }
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        viewHolder.diffText.setTextColor(Color.parseColor("#FAC81E"));
        viewHolder.diffText.setText(String.valueOf(score.getDifficulty_h()));
