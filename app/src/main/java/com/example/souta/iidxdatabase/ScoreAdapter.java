...
public class ScoreAdapter extends RealmBaseAdapter<Score> implements ListAdapter {
    ...
    public ScoreAdapter(Context context, OrderedRealmCollection<Score> data) {
        super(context, data);
    }
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        viewHolder.diffText.setTextColor(Color.parseColor("#32D9E6"));
        viewHolder.diffText.setText(String.valueOf(score.getDifficulty_n()));
